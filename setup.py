...
VERSION_PY_FILENAME = 'oscar/_version.py'
VERSION_PY = """\
# This file can be generated from Git information by running 'setup.py version'.
...
setup(name='oscar',
      version=get_version(),
      description='Control Ardour with TouchOSC',
      author='Burkhard Ritter',
      author_email='burkhard@seite9.de',
      license='',
      url='https://github.com/meznom/oscar',
      packages=['oscar'],
      scripts=['bin/oscar'],
